...
// Оба способа, которые вы представили, работают и будут давать правильные результаты. 
// Выбор между ними зависит от вашего предпочтения и конкретных требований вашей задачи.
